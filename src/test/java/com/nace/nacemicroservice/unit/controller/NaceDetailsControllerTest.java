package com.nace.nacemicroservice.unit.controller;

import com.nace.nacemicroservice.builder.ApiResponseBuilder;
import com.nace.nacemicroservice.constants.NaceEnum;
import com.nace.nacemicroservice.controller.NaceDetailsController;
...
public class NaceDetailsControllerTest {
    ...
    private static final String VALID_CSV_FILE_PATH = "NACE_REV2_20220314_073032.csv";
    ...
    private ResponseEntity<List<GetNaceDetailsDto>> constructGetSuccessResponse(List<NaceDetailsEntity> resultArg) {
        ...
        resultArg.stream().forEach(result -> {
            fetchedNaceRecords.add(GetNaceDetailsDto.builder().order(result.getOrder()).level(result.getLevel())
                    ...
                    .referencesIsic(result.getReferenceIsic()).build());
        });
